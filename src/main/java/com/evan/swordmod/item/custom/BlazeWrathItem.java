...
public class BlazeWrathItem extends SwordItem {
    public BlazeWrathItem(Tier tier, int damage, float atkspeed, Properties propertiesp) {
    ...
    private void shoot(Player player,Level level){
       ...
       SmallFireball fireball = new SmallFireball(level, player, x - player.getX(), y - player.getEyeY(), z - player.getZ());
